...
import Admin2FATab from '../components/Admin2FATab'
...
type Tab = 'users' | 'audit' | 'notifications' | 'reports' | 'twofa'
    ...
    <div className="min-h-screen bg-gray-900 text-white pb-8">
      ...
      <div className="p-4">
        ...
        <Card className="bg-gray-800 p-4">
          {tab === 'users' ? renderUsersTab() : tab === 'audit' ? renderAuditTab() : tab === 'notifications' ? renderNotificationsTab() : tab === 'reports' ? renderReportsTab() : <Admin2FATab />}
        </Card>
      </div>
